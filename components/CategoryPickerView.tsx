  ...
  return (
    <div className="absolute inset-0 z-[60] flex items-end justify-center">
        ...
        <div className="bg-ios-bg w-full max-w-md h-[85vh] rounded-t-[2rem] flex flex-col shadow-2xl animate-slide-up relative overflow-hidden">
            ...
            {/* Header */}
            <div className="px-4 py-3 border-b border-ios-separator/20 flex justify-between items-center flex-shrink-0">
            ...
            {/* Search Bar - Fixed */}
            <div className="px-4 py-3 bg-ios-bg flex-shrink-0 z-10 border-b border-ios-separator/10">
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar">
                ...
                {!searchText && suggestions.length > 0 && (
                    <div className="px-4 mt-3 mb-6 animate-fade-in">
